      ...
      a.extend(L.prototype, {
        setup: function () {
          ...
          if (
            ((i = l.settings.mode),
            (j = q.attr("class") || ""),
            (b = a("<div>").addClass(m.wrapperClass).addClass(j).addClass(i)),
            (c = a("<div>")
            ...
            (d = a('<input type="text" autocomplete="off" />')
              .appendTo(c)
              .attr("tabindex", q.is(":disabled") ? "-1" : l.tabIndex)),
            ...
            (e = a("<div>")
              ...
              .hide()
              .appendTo(h)),
            (g = a("<div>").addClass(m.dropdownContentClass).appendTo(e)),
            ...
            l.settings.placeholder && d.attr("placeholder", m.placeholder),
          ...
          q.attr("autocorrect") && d.attr("autocorrect", q.attr("autocorrect")),
            ...
            a.isArray(m.items) && (l.setValue(m.items), delete m.items),
            x &&
